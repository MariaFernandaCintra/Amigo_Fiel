...
Inserção de registros em todas as tabelas do sistema (clientes, endereços, pets, funcionários, serviços, atendimentos, produtos e fornecedores).

### READ – Consulta de Dados

Consultas realizadas para verificar os dados cadastrados, como listagem de clientes, pets e atendimentos.

### UPDATE – Atualização de Dados

Atualização de informações previamente cadastradas, como dados de contato de clientes e informações de produtos.

### DELETE – Exclusão de Dados

Exclusão de registros das tabelas do sistema.
